    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[70vh] text-center p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto justify-center">
                <Link
                    href="/"
                    className="flex items-center justify-center gap-2 px-6 py-2 bg-brand-600 text-white rounded-lg hover:bg-brand-700 transition-colors font-medium shadow-sm shadow-brand-100"
                >
                    <Home size={18} />
                    Return Home
                </Link>
